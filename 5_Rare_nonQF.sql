	DROP TABLE IF EXISTS Final_Rare_Variants_nonQF;
	create table Final_Rare_Variants_nonQF as (select `Chr`,`Start`,`End`,`Ref`,`Alt`,`Func_refGene`,`Gene_refGene`,`GeneDetail_refGene`,`ExonicFunc_refGene`,`AAChange_refGene`,`xref_refGene`,`avsnp147`,
...
`DP`,`AD`,`GQ`,`PL`,`RNC`,`sampleID` from MC_001_1 spv where 1=2);
	CREATE INDEX Final_Rare_Variants_nonQF_Chr_IDX USING BTREE ON dfw_updated.Final_Rare_Variants_nonQF (Chr,`Start`,`End`);
	...
	FROM dfw_updated.Final_Pedigree where Seq_Notes not like '%Not sequenced%' and Seq_Notes not like '%Not Sequenced%';
	...
	REPEAT
    	...
    	# variants
    	SET @sql = CONCAT('insert into Final_Rare_Variants_nonQF select `Chr`,`Start`,`End`,`Ref`,`Alt`,`Func_refGene`,`Gene_refGene`,`GeneDetail_refGene`,`ExonicFunc_refGene`,`AAChange_refGene`,`xref_refGene`,`avsnp147`,
	`SIFT_score`,`SIFT_pred`,`Polyphen2_HDIV_score`,`Polyphen2_HDIV_pred`,`Polyphen2_HVAR_score`,`Polyphen2_HVAR_pred`,`LRT_score`,`LRT_pred`,`MutationTaster_score`,`MutationTaster_pred`,
`MutationAssessor_score`,`MutationAssessor_pred`,`FATHMM_score`,`FATHMM_pred`,`PROVEAN_score`,`PROVEAN_pred`,`VEST3_score`,`CADD_raw`,`CADD_phred`,`DANN_score`,`fathmm-MKL_coding_score`,
`fathmm-MKL_coding_pred`,`MetaSVM_score`,`MetaSVM_pred`,`MetaLR_score`,`MetaLR_pred`,`integrated_fitCons_score`,`integrated_confidence_value`,`GERP++_RS`,`phyloP7way_vertebrate`,
`phyloP20way_mammalian`,`phastCons7way_vertebrate`,`phastCons20way_mammalian`,`SiPhy_29way_logOdds`,`dbscSNV_ADA_SCORE`,`dbscSNV_RF_SCORE`,`MCAP`,`REVEL`,`DN ID`,`Patient ID`,`Phenotype`,`Platform`,
...
`DP`,`AD`,`GQ`,`PL`,`RNC`,`sampleID` from ', @sample, 
    		' where Otherinfo1 != 0 and greatest(ExAC_ALL, ExAC_AFR, ExAC_AMR, ExAC_EAS, ExAC_FIN, ExAC_NFE, ExAC_OTH, ExAC_SAS, AF_exome, AF_afr_exome, AF_sas_exome,
