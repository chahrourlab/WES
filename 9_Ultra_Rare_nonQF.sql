	DROP TABLE IF EXISTS Final_Ultra_Rare_Variants_nonQF;
	create table Final_Ultra_Rare_Variants_nonQF as select * from Final_Rare_Variants_nonQF 
		 where greatest(ExAC_ALL, ExAC_AFR, ExAC_AMR, ExAC_EAS, ExAC_FIN, ExAC_NFE, ExAC_OTH, ExAC_SAS, AF_exome, AF_afr_exome, AF_sas_exome,
			...
			`1000g2015aug_sas`) = 0;
	CREATE INDEX Final_Ultra_Rare_Variants_nonQF_Chr_IDX USING BTREE ON dfw_updated.Final_Ultra_Rare_Variants_nonQF (Chr,`Start`,`End`);